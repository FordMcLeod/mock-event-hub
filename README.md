...
To see a quick example of how to start the mock service, look at [here](https://github.com/Azure/azure-sdk-for-js/blob/main/sdk/eventhub/mock-hub/samples/INSTRUCTIONS.md).
